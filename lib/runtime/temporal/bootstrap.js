...
const PLANNING_ARTIFACTS_DIRNAME = 'planning-artifacts';
const WORK_UNIT_ARTIFACTS_DIRNAME = 'work-unit-artifacts';
...
function resolveRuntimePaths(repoRoot = process.cwd()) {
  ...
  return {
    ...
    planningArtifactsDir: path.join(runtimeRoot, PLANNING_ARTIFACTS_DIRNAME),
    workUnitArtifactsDir: path.join(runtimeRoot, WORK_UNIT_ARTIFACTS_DIRNAME),
  };
}
...
module.exports = {
  ...
  LAUNCHES_DIRNAME,
  PLANNING_ARTIFACTS_DIRNAME,
  REVIEWS_DIRNAME,
  SCHEDULES_DIRNAME,
  TASK_DEFINITIONS_DIRNAME,
  WORK_UNIT_ARTIFACTS_DIRNAME,
